...
public class UserServiceImpl implements UserService {
    ...
    public List<NutritionixDetailedProduct> foodConsumedToday() {
        ...
        User currentUser = (User) userRepository.findUserByUsername(((UserDetails)principal).getUsername()).block();
    ...
    public User saveNewUser(User user){
        ...
        User nullIfUserDoesNotExist1 = (User) userRepository.findUserByUsername(user.getUsername()).block();
        if (nullIfUserDoesNotExist1 != null){
            throw new BadRequestException("User already exists with username: "+user.getUsername());
        }

        User nullIfUserDoesNotExist2 = (User) userRepository.findUserByEmail(user.getEmail()).block();
    ...
    public User updatePassword(User user) {
        ...
        User currentUserObject = (User) userRepository.findUserByUsername(user.getUsername()).block();
